...
@StaticBuilder(RefTypeView.class)
public abstract class RefTypeViewBuilder<BuilderType extends EntityViewBuilderBase<RefTypeView, BuilderType>> implements EntityViewBuilderBase<RefTypeView, BuilderType> {

    protected Long id;
    protected final Map<String, Object> optionalParameters;

    public RefTypeViewBuilder(Map<String, Object> optionalParameters) {
        this.id = null;
    ...
    @Override
    public <E> BuilderType with(SingularAttribute<RefTypeView, E> attribute, E value) {
        return with((Attribute<?, ?>) attribute, value);
    }

    @Override
    public <C> BuilderType with(PluralAttribute<RefTypeView, C, ?> attribute, C value) {
        return with((Attribute<?, ?>) attribute, value);
    }
    ...
    @Override
    public <E> E get(SingularAttribute<RefTypeView, E> attribute) {
        return get((Attribute<?, ?>) attribute);
    }

    @Override
    public <C> C get(PluralAttribute<RefTypeView, C, ?> attribute) {
        return get((Attribute<?, ?>) attribute);
    }
    ...
    @Override
    public <E> BuilderType withElement(CollectionAttribute<RefTypeView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withElement(SetAttribute<RefTypeView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withElement(ListAttribute<RefTypeView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withListElement(ListAttribute<RefTypeView, E> attribute, int index, E value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <K, V> BuilderType withEntry(MapAttribute<RefTypeView, K, V> attribute, K key, V value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(SingularAttribute<RefTypeView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(CollectionAttribute<RefTypeView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(ListAttribute<RefTypeView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(ListAttribute<RefTypeView, E> attr, int index) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(SetAttribute<RefTypeView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<V, BuilderType> withBuilder(MapAttribute<RefTypeView, K, V> attr, K key) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, BuilderType>> withBuilder(MapAttribute<RefTypeView, K, V> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    public static class Init extends RefTypeViewBuilder<EntityViewBuilder<RefTypeView>> implements EntityViewBuilder<RefTypeView> {
        ...
        @Override
        public RefTypeView build() {
            return new RefTypeViewImpl(
            this.id
            );
        }

        @Override
        public EntityViewBuilder<RefTypeView> with(int parameterIndex, Object value) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeView>> withSingularBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeView>> withCollectionBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeView>> withListBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeView>> withListBuilder(int parameterIndex, int index) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeView>> withSetBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <V> EntityViewNestedBuilder<V, EntityViewBuilder<RefTypeView>> withMapBuilder(int parameterIndex, Object key) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, EntityViewBuilder<RefTypeView>>> withMapBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    public static class Nested<BuilderResult> extends RefTypeViewBuilder<EntityViewNestedBuilder<RefTypeView, BuilderResult>> implements EntityViewNestedBuilder<RefTypeView, BuilderResult> {
        ...
        public BuilderResult build() {
            listener.onBuildComplete(new RefTypeViewImpl(
            this.id
            ));
            return result;
        }
        ...
        @Override
        public EntityViewNestedBuilder<RefTypeView, BuilderResult> with(int parameterIndex, Object value) {
        switch (parameterIndex) {
            default:
                throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
        }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeView, BuilderResult>> withSingularBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeView, BuilderResult>> withCollectionBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeView, BuilderResult>> withListBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeView, BuilderResult>> withListBuilder(int parameterIndex, int index) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeView, BuilderResult>> withSetBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <V> EntityViewNestedBuilder<V, EntityViewNestedBuilder<RefTypeView, BuilderResult>> withMapBuilder(int parameterIndex, Object key) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, EntityViewNestedBuilder<RefTypeView, BuilderResult>>> withMapBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
