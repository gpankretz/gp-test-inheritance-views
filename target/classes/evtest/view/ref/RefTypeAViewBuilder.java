...
@StaticBuilder(RefTypeAView.class)
public abstract class RefTypeAViewBuilder<BuilderType extends EntityViewBuilderBase<RefTypeAView, BuilderType>> implements EntityViewBuilderBase<RefTypeAView, BuilderType> {

    protected Long id;
    protected String valueA;
    protected final Map<String, Object> optionalParameters;

    public RefTypeAViewBuilder(Map<String, Object> optionalParameters) {
        this.id = null;
        this.valueA = null;
    ...
    public BuilderType withValueA(String valueA) {
        this.valueA = valueA;
        return (BuilderType) this;
    }
    ...
    public BuilderType with(String attribute, Object value) {
        switch (attribute) {
            case "id":
                ...
                break;
            case "valueA":
                this.valueA = value == null ? null : (String) value;
                break;
            default:
    ...
    @Override
    public <E> BuilderType with(SingularAttribute<RefTypeAView, E> attribute, E value) {
        return with((Attribute<?, ?>) attribute, value);
    }

    @Override
    public <C> BuilderType with(PluralAttribute<RefTypeAView, C, ?> attribute, C value) {
        return with((Attribute<?, ?>) attribute, value);
    }
    ...
    public <E> E get(String attribute) {
        switch (attribute) {
            ...
            case "valueA":
                return (E) (Object) this.valueA;
        }
        throw new IllegalArgumentException("Unknown attribute: " + attribute);
    }

    @Override
    public <E> E get(SingularAttribute<RefTypeAView, E> attribute) {
        return get((Attribute<?, ?>) attribute);
    }

    @Override
    public <C> C get(PluralAttribute<RefTypeAView, C, ?> attribute) {
        return get((Attribute<?, ?>) attribute);
    }
    ...
    @Override
    public <E> BuilderType withElement(CollectionAttribute<RefTypeAView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withElement(SetAttribute<RefTypeAView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withElement(ListAttribute<RefTypeAView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withListElement(ListAttribute<RefTypeAView, E> attribute, int index, E value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <K, V> BuilderType withEntry(MapAttribute<RefTypeAView, K, V> attribute, K key, V value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(SingularAttribute<RefTypeAView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(CollectionAttribute<RefTypeAView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(ListAttribute<RefTypeAView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(ListAttribute<RefTypeAView, E> attr, int index) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(SetAttribute<RefTypeAView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<V, BuilderType> withBuilder(MapAttribute<RefTypeAView, K, V> attr, K key) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, BuilderType>> withBuilder(MapAttribute<RefTypeAView, K, V> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    public static class Init extends RefTypeAViewBuilder<EntityViewBuilder<RefTypeAView>> implements EntityViewBuilder<RefTypeAView> {
        ...
        @Override
        public RefTypeAView build() {
            return new RefTypeAViewImpl(
            this.id,
            this.valueA
            );
        }
        ...
        @Override
        public EntityViewBuilder<RefTypeAView> with(int parameterIndex, Object value) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeAView>> withSingularBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeAView>> withCollectionBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeAView>> withListBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeAView>> withListBuilder(int parameterIndex, int index) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<RefTypeAView>> withSetBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <V> EntityViewNestedBuilder<V, EntityViewBuilder<RefTypeAView>> withMapBuilder(int parameterIndex, Object key) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, EntityViewBuilder<RefTypeAView>>> withMapBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    public static class Nested<BuilderResult> extends RefTypeAViewBuilder<EntityViewNestedBuilder<RefTypeAView, BuilderResult>> implements EntityViewNestedBuilder<RefTypeAView, BuilderResult> {
        ...
        public BuilderResult build() {
            listener.onBuildComplete(new RefTypeAViewImpl(
            this.id,
            this.valueA
            ));
            return result;
        ...
        @Override
        public EntityViewNestedBuilder<RefTypeAView, BuilderResult> with(int parameterIndex, Object value) {
        switch (parameterIndex) {
            default:
                throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
        }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeAView, BuilderResult>> withSingularBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeAView, BuilderResult>> withCollectionBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeAView, BuilderResult>> withListBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeAView, BuilderResult>> withListBuilder(int parameterIndex, int index) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<RefTypeAView, BuilderResult>> withSetBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <V> EntityViewNestedBuilder<V, EntityViewNestedBuilder<RefTypeAView, BuilderResult>> withMapBuilder(int parameterIndex, Object key) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, EntityViewNestedBuilder<RefTypeAView, BuilderResult>>> withMapBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
