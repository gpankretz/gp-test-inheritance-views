...
import evtest.view.ref.RefTypeViewBaseBuilder;
...
@StaticBuilder(ItemTypeBaseView.class)
public abstract class ItemTypeBaseViewBuilder<BuilderType extends EntityViewBuilderBase<ItemTypeBaseView, BuilderType>> implements EntityViewBuilderBase<ItemTypeBaseView, BuilderType> {

    protected RefTypeViewBase _refType;
    protected long id;
    protected final Map<String, Object> optionalParameters;

    public ItemTypeBaseViewBuilder(Map<String, Object> optionalParameters) {
        this._refType = null;
        this.id = 0L;
    ...
    public void set_refType(RefTypeViewBase _refType) {
        this._refType = _refType;
    }
    public BuilderType with_refType(RefTypeViewBase _refType) {
        this._refType = _refType;
        return (BuilderType) this;
    }
    public RefTypeViewBaseBuilder.Nested<BuilderType> with_refTypeBuilder() {
    return new RefTypeViewBaseBuilder.Nested<>(optionalParameters, new SingularNameEntityViewBuilderListener(this, "_refType"), (BuilderType) this);
    }
    ...
    public BuilderType with(String attribute, Object value) {
        switch (attribute) {
            case "_refType":
                this._refType = value == null ? null : (RefTypeViewBase) value;
                break;
            case "id":
    ...
    @Override
    public <E> BuilderType with(SingularAttribute<ItemTypeBaseView, E> attribute, E value) {
        return with((Attribute<?, ?>) attribute, value);
    }

    @Override
    public <C> BuilderType with(PluralAttribute<ItemTypeBaseView, C, ?> attribute, C value) {
        return with((Attribute<?, ?>) attribute, value);
    }
    ...
    @Override
    public <E> E get(SingularAttribute<ItemTypeBaseView, E> attribute) {
        return get((Attribute<?, ?>) attribute);
    }

    @Override
    public <C> C get(PluralAttribute<ItemTypeBaseView, C, ?> attribute) {
        return get((Attribute<?, ?>) attribute);
    }
    ...
    @Override
    public <E> BuilderType withElement(CollectionAttribute<ItemTypeBaseView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withElement(SetAttribute<ItemTypeBaseView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withElement(ListAttribute<ItemTypeBaseView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withListElement(ListAttribute<ItemTypeBaseView, E> attribute, int index, E value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <K, V> BuilderType withEntry(MapAttribute<ItemTypeBaseView, K, V> attribute, K key, V value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(SingularAttribute<ItemTypeBaseView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(CollectionAttribute<ItemTypeBaseView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(ListAttribute<ItemTypeBaseView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(ListAttribute<ItemTypeBaseView, E> attr, int index) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(SetAttribute<ItemTypeBaseView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<V, BuilderType> withBuilder(MapAttribute<ItemTypeBaseView, K, V> attr, K key) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, BuilderType>> withBuilder(MapAttribute<ItemTypeBaseView, K, V> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    public static class Init extends ItemTypeBaseViewBuilder<EntityViewBuilder<ItemTypeBaseView>> implements EntityViewBuilder<ItemTypeBaseView> {
        ...
        @Override
        public ItemTypeBaseView build() {
            return new ItemTypeBaseViewImpl(
            this.id,
            this._refType
            );
        }
        ...
        @Override
        public EntityViewBuilder<ItemTypeBaseView> with(int parameterIndex, Object value) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBaseView>> withSingularBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBaseView>> withCollectionBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBaseView>> withListBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBaseView>> withListBuilder(int parameterIndex, int index) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBaseView>> withSetBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <V> EntityViewNestedBuilder<V, EntityViewBuilder<ItemTypeBaseView>> withMapBuilder(int parameterIndex, Object key) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, EntityViewBuilder<ItemTypeBaseView>>> withMapBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    public static class Nested<BuilderResult> extends ItemTypeBaseViewBuilder<EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult>> implements EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult> {
        ...
        public BuilderResult build() {
            listener.onBuildComplete(new ItemTypeBaseViewImpl(
            this.id,
            this._refType
            ));
            return result;
        ...
        @Override
        public EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult> with(int parameterIndex, Object value) {
        switch (parameterIndex) {
            default:
                throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
        }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult>> withSingularBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult>> withCollectionBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult>> withListBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult>> withListBuilder(int parameterIndex, int index) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult>> withSetBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <V> EntityViewNestedBuilder<V, EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult>> withMapBuilder(int parameterIndex, Object key) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, EntityViewNestedBuilder<ItemTypeBaseView, BuilderResult>>> withMapBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
