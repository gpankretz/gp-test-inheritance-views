...
public class ItemTypeBViewRelation<T, A extends MethodAttribute<?, ?>> extends AttributePathWrapper<T, ItemTypeBView, ItemTypeBView> {

    public ItemTypeBViewRelation(AttributePath<T, ItemTypeBView, ItemTypeBView> path) {
        super(path);
    }
