...
import evtest.view.ref.RefTypeBViewBuilder;
...
@StaticBuilder(ItemTypeBView.class)
public abstract class ItemTypeBViewBuilder<BuilderType extends EntityViewBuilderBase<ItemTypeBView, BuilderType>> implements EntityViewBuilderBase<ItemTypeBView, BuilderType> {

    protected RefTypeBView _refType;
    protected String dscrItem;
    protected long id;
    protected final Map<String, Object> optionalParameters;

    public ItemTypeBViewBuilder(Map<String, Object> optionalParameters) {
        this._refType = null;
        this.dscrItem = null;
        this.id = 0L;
    ...
    public void set_refType(RefTypeBView _refType) {
        this._refType = _refType;
    }
    public BuilderType with_refType(RefTypeBView _refType) {
        this._refType = _refType;
        return (BuilderType) this;
    }
    public RefTypeBViewBuilder.Nested<BuilderType> with_refTypeBuilder() {
    return new RefTypeBViewBuilder.Nested<>(optionalParameters, new SingularNameEntityViewBuilderListener(this, "_refType"), (BuilderType) this);
    }
    ...
    public BuilderType with(String attribute, Object value) {
        switch (attribute) {
            case "_refType":
                this._refType = value == null ? null : (RefTypeBView) value;
                break;
            case "dscrItem":
    ...
    @Override
    public <E> BuilderType with(SingularAttribute<ItemTypeBView, E> attribute, E value) {
        return with((Attribute<?, ?>) attribute, value);
    }

    @Override
    public <C> BuilderType with(PluralAttribute<ItemTypeBView, C, ?> attribute, C value) {
        return with((Attribute<?, ?>) attribute, value);
    }
    ...
    @Override
    public <E> E get(SingularAttribute<ItemTypeBView, E> attribute) {
        return get((Attribute<?, ?>) attribute);
    }

    @Override
    public <C> C get(PluralAttribute<ItemTypeBView, C, ?> attribute) {
        return get((Attribute<?, ?>) attribute);
    }
    ...
    @Override
    public <E> BuilderType withElement(CollectionAttribute<ItemTypeBView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withElement(SetAttribute<ItemTypeBView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withElement(ListAttribute<ItemTypeBView, E> attribute, E value) {
        getCollection(attribute).add(value);
        return (BuilderType) this;
    }

    @Override
    public <E> BuilderType withListElement(ListAttribute<ItemTypeBView, E> attribute, int index, E value) {
        List<Object> list = getCollection(attribute);
        addListValue(list, index, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <K, V> BuilderType withEntry(MapAttribute<ItemTypeBView, K, V> attribute, K key, V value) {
        Map<Object, Object> map = getMap(attribute);
        map.put(key, value);
        return (BuilderType) this;
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(SingularAttribute<ItemTypeBView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(CollectionAttribute<ItemTypeBView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(ListAttribute<ItemTypeBView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(ListAttribute<ItemTypeBView, E> attr, int index) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, BuilderType> withBuilder(SetAttribute<ItemTypeBView, E> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<V, BuilderType> withBuilder(MapAttribute<ItemTypeBView, K, V> attr, K key) {
        if (attr instanceof MethodAttribute) {
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, BuilderType>> withBuilder(MapAttribute<ItemTypeBView, K, V> attr) {
        if (attr instanceof MethodAttribute) {
    ...
    public static class Init extends ItemTypeBViewBuilder<EntityViewBuilder<ItemTypeBView>> implements EntityViewBuilder<ItemTypeBView> {
        ...
        @Override
        public ItemTypeBView build() {
            return new ItemTypeBViewImpl(
            this.id,
            this._refType,
            this.dscrItem
            );
        ...
        @Override
        public EntityViewBuilder<ItemTypeBView> with(int parameterIndex, Object value) {
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBView>> withSingularBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBView>> withCollectionBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBView>> withListBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBView>> withListBuilder(int parameterIndex, int index) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewBuilder<ItemTypeBView>> withSetBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <V> EntityViewNestedBuilder<V, EntityViewBuilder<ItemTypeBView>> withMapBuilder(int parameterIndex, Object key) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, EntityViewBuilder<ItemTypeBView>>> withMapBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    public static class Nested<BuilderResult> extends ItemTypeBViewBuilder<EntityViewNestedBuilder<ItemTypeBView, BuilderResult>> implements EntityViewNestedBuilder<ItemTypeBView, BuilderResult> {
        ...
        public BuilderResult build() {
            listener.onBuildComplete(new ItemTypeBViewImpl(
            this.id,
            this._refType,
            this.dscrItem
            ));
        ...
        @Override
        public EntityViewNestedBuilder<ItemTypeBView, BuilderResult> with(int parameterIndex, Object value) {
        switch (parameterIndex) {
            default:
                throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
        }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBView, BuilderResult>> withSingularBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBView, BuilderResult>> withCollectionBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBView, BuilderResult>> withListBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBView, BuilderResult>> withListBuilder(int parameterIndex, int index) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <E> EntityViewNestedBuilder<E, EntityViewNestedBuilder<ItemTypeBView, BuilderResult>> withSetBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <V> EntityViewNestedBuilder<V, EntityViewNestedBuilder<ItemTypeBView, BuilderResult>> withMapBuilder(int parameterIndex, Object key) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
    ...
    @Override
    public <K, V> EntityViewNestedBuilder<K, EntityViewNestedBuilder<V, EntityViewNestedBuilder<ItemTypeBView, BuilderResult>>> withMapBuilder(int parameterIndex) {
        switch (parameterIndex) {
        }
        throw new IllegalArgumentException("Unknown parameter index: " + parameterIndex);
    }
